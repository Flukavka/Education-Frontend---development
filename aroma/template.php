                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
                            ...
                            <li class="nav-item active submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="/category">Каталог товаров</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/single-product">О продукте</a></li>
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="/tracking-order">Отслеживание</a></li>
                                </ul>
                            </li>
